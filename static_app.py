    ...
    <section class="hero-section" id="home">
        <div class="container text-center">
            ...
            <div class="alert alert-info mb-4">
                <i class="fas fa-info-circle"></i> <strong>Նշում:</strong> Այս GitHub Pages տարբերակը ցույց է տալիս մեր հավելվածի հնարավորությունները: Լիարժեք օգտագործման համար անհրաժեշտ է տեղակայել Python սերվերի վրա կամ աշխատեցնել տեղականորեն:
            </div>
        </div>
    </section>
